...
-(NSString *)textField:(HTAutocompleteTextField *)textField completionForPrefix:(NSString *)prefix ignoreCase:(BOOL)ignoreCase{
    ...
    if ([textComponents count] > 1)
    {
        ...
        {
            return [self.autocompleteArray objectAtIndex:0];
        }
