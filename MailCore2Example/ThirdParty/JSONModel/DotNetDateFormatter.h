 ...
 */
@interface DotNetDateFormatter : NSDateFormatter {
    NSRegularExpression *dotNetExpression;
}

/**
 Instantiates an autoreleased DotNetDateFormatter object with the timezone set to UTC
 (Greenwich Mean Time).
 
 @return An autoreleased DotNetDateFormatter object
 @see dotNetDateFormatterWithTimeZone
 */
+ (DotNetDateFormatter *)dotNetDateFormatter;

/**
 Instantiates an autoreleased DotNetDateFormatter object.
 ...
 */
+ (DotNetDateFormatter *)dotNetDateFormatterWithTimeZone:(NSTimeZone *)timeZone;
