...
-(void)setFrame:(CGRect)frame{
    ...
    _contentView.frame = CGRectMake((self.bounds.size.width - _initialContentSize.width) / 2  , (self.bounds.size.height - barheight - _initialContentSize.height) / 2 + barheight, _initialContentSize.width, _initialContentSize.height);
    
    _cropBorderView.frame = CGRectMake(_contentView.frame.origin.x - kBorderCorrectionValue, _contentView.frame.origin.y - kBorderCorrectionValue, _initialContentSize.width + kBorderCorrectionValue*2, _initialContentSize.height + kBorderCorrectionValue*2);
}
...
-(void)_addContentViews{
    ...
    _cropBorderView = [[GKCropBorderView alloc] init];
...
-(CGRect)_preventBorderFrameFromGettingTooSmallOrTooBig:(CGRect)newFrame{
    ...
    if (newFrame.origin.y < barheight){
